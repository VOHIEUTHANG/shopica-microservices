...
async Task SeedDataAsync(WebApplication app)
{
    ...
    var logger = scope.ServiceProvider.GetRequiredService<ILogger<PaymentContextSeed>>();

    await new PaymentContextSeed().SeedAsync(context, env, app.Configuration, logger);

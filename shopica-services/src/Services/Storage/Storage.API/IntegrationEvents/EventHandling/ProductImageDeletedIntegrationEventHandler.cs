...
public class ProductImageDeletedIntegrationEventHandler : IIntegrationEventHandler<ProductImageDeletedIntegrationEvent>
{
    private readonly ILogger<CategoryDeletedIntegrationEventHandler> _logger;
    private readonly IAwsS3Service _awsS3Service;
    public ProductImageDeletedIntegrationEventHandler(
    ...
    public async Task Handle(ProductImageDeletedIntegrationEvent @event)
    {

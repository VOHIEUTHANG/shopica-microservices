...
async Task SeedDataAsync(WebApplication app)
{
    ...
    var logger = scope.ServiceProvider.GetRequiredService<ILogger<InventoryContextSeed>>();

    await new InventoryContextSeed().SeedAsync(context, app.Configuration, logger);
